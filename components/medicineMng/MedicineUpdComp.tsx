  ...
  return (
    <>
      <div className="mainComponent">
        ...
        <div className="m-auto	mt-20">{domLoaded && <MedicineDtlTable mDtlInfo={mDtlInfo} />}</div>
        <div className="space20"></div>
        <h1 className="">관리자 메모</h1>
        <div className="w-full h-[150px] rounded-md bg-[#d9d9d9] border-4 border-[#b6b6b6] p-10">{mDtlInfo.admin_comment}</div>
      </div>
    </>
  );
};
